          ...
          <div className="row">
            <div className="col-3">
                ...
                <div>
                  ...
                  <div>
                    <div className="form-check">
                      ...
                      />
                      <label htmlFor="in-store" className="form-check-label">
                        In Store
                      </label>
                    </div>
                    <div className="form-check">
                ...
                <div>
                  ...
                  <div className="form-check">
                    <input
                      ...
                      className="form-check-input"
                    />
                    <label htmlFor="size-6" className="form-check-label">
                      XL (2)
                    </label>
                  </div>
                  <div className="form-check">
              ...
              <div className="filter-card mb-3">
                ...
                <div>
                  <div className="product-tags d-flex flex-wrap items-center gap-10">
                    <span className="badge bg-light text-secondary rounded-3 p-3">
                      Headphone
                    </span>
